        ...
        <div class="main-content fl-right">
                ...
                <div class="section-detail clearfix">
                    <div class="thumb-wp fl-left">
                        <a href="" title="" id="main-thumb">
                            <img id="zoom" src="admin/<?php echo $product['product_main_image_url'] ?>" data-zoom-image="admin/<?php echo $product['product_main_image_url'] ?>"/>
                        </a>
                        <div id="list-thumb">
                            <a href="" data-image="admin/<?php echo $product['product_main_image_url'] ?>" data-zoom-image="admin/<?php echo $product['product_main_image_url'] ?>">
                                <img id="zoom" src="admin/<?php echo $product['product_main_image_url'] ?>" />
                            </a>
                    ...
                    <div class="info fl-right">
                        ...
                        <form action="" method="post">
                            ...
                            <button type="submit" name="btn-submit" class="btn-add-to-cart">
                            <a href="?mod=cart&action=addCart&id=<?php echo $product['id'] ?>" title="Thêm giỏ hàng" class="add-cart">Thêm giỏ hàng</a>
                            </button>
                        </form>
                    </div>
                </div>
            ...
            <div class="section" id="post-product-wp">
                ...
                <div class="section-detail">
                    <?php echo $product['detail_description']; ?>
                </div>
            </div>
            <div class="section" id="same-category-wp">
                ...
                <div class="section-detail">
                    <ul class="list-item">
                        <?php foreach( $relate_product as $products ) { ?>
                        <li>
                            <a href="" title="" class="thumb">
                                <img src="admin/<?php echo $products['product_main_image_url'] ?>">
                            </a>
                            <a href="" title="" class="product-name"><?php echo $products['product_name'] ?></a>
                            <div class="price">
                                <span class="new"><?php echo currency_format($products['product_price']); ?></span>
