...
<body>
    <div id="wp_form_login">
        ...
        <a class="lost-pass" href="<?php echo base_url("?mod=users&action=resetpass");?>">Forgot password?</a> |
        <a class="lost-pass" href="<?php echo base_url("?mod=users&action=reg");?>">Đăng ký</a>
