                    ...
                    <div class="wp-inner clearfix">
                        ...
                        <ul id="main-menu" class="fl-left">
                            ...
                            <li>
                                ...
                                <ul class="sub-menu">
                                    ...
                                    <li>
                                        <a href="?mod=products&controller=category&action=index" title="">Danh mục sản phẩm</a> 
                                    </li>
                                    <!-- <li>
                                        <a href="danh-muc-1.html" title="">Danh mục sản phẩm</a> 
                                    </li> -->
                                </ul>
                            </li>
                            <li>
                                ...
                                <ul class="sub-menu">
                                    ...
                                    <li>
                                        <a href="?mod=order&action=listCustomer" title="">Danh sách khách hàng</a> 
                                    </li>
                                </ul>
                            </li>
                            <li>
                        ...
                        <div id="dropdown-user" class="dropdown dropdown-extended fl-right">
                            <button class="dropdown-toggle clearfix" type="button"  data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
                                ...
                                <h3 id="account" class="fl-right"> <?php if($_SESSION['user_login']) echo user_login(); ?></h3>
                            </button>
...
<body>
    ...
    <?php if( !empty($_SESSION['user_login']) ) : ?>
        <div class="top-bar-menu">
            <p>Xin chao <?php echo $_SESSION['user_login'] ?>!! <a href="?mod=users&action=logout">LogOut</a></p>
        </div>
        <?php endif; ?>
        <div id="header">
            <ul id="main_menu">
                <li><a href="?">Trang chu</a></li>
                <li><a href="?mod=home&controller=index">Gioi thieu</a></li>
                <li><a href="?mod=users&controller=index&action=reg">Thanh Vien</a></li>
                <li><a href="?mod=users&controller=index">Danh sach Thanh Vien</a></li>
            </ul>
        </div> -->